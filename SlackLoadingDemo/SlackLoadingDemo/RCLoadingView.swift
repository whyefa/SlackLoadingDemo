...
class RCLLoadingView: UIView, CAAnimationDelegate {
    ...
    private func angleAnimation() {
        ...
        angleAnimation.toValue             = angle(150)
    ...
    private func lineAnimationOne() {
        ...
        lineAnimationOne.duration            = duration
    ...
    private func lineAnimationThree() {
        ...
        lineAnimationFour.duration              = duration/2
